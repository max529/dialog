...
let _n;
const Dialog = class Dialog extends Aventus.WebComponent {
    callback;
    static __style = `:host .hider{align-items:center;background-color:rgba(0,0,0,.2);display:flex;inset:0;justify-content:center;position:fixed}:host .hider .popup{background-color:#fff;padding:32px;box-shadow:0 0 5px #000;border-radius:5px}`;
    constructor() { super(); if (this.constructor == Dialog) { throw "can't instanciate an abstract class"; } }
    __getStatic() {
        return Dialog;
    }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(Dialog.__style);
        return arrStyle;
    }
    __getHtml() {
    this.__getStatic().__template.setHTML({
        slots: { 'default':`<slot></slot>` }, 
        blocks: { 'default':`<div class="hider">    <div class="popup">        <slot></slot>    </div></div>` }
    });
}
    getClassName() {
        return "Dialog";
...
_.DialogService=DialogService;

let Person=class Person extends Aventus.Data {
    id = 0;
    firstname = "";
    lastname = "";
}
Person.Namespace=`dialog`;
Person.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","firstname":"string","lastname":"string"};
Aventus.Converter.register(Person.Fullname, Person);
_.Person=Person;

const CustomDialog = class CustomDialog extends Dialog {
    get 'person'() {
    ...
    this.__addWatchesActions("person");    super.__registerWatchesActions();
}
    static __style = `:host .btns{display:flex;justify-content:flex-end;gap:10px}`;
    __getStatic() {
        return CustomDialog;
    }
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(CustomDialog.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<div class="field">    <label for="firstname">Firstname</label>    <input name="firstname" _id="customdialog_0" /></div><div class="field">    <label for="lastname">Lastname</label>    <input name="lastname" _id="customdialog_1" /></div><div class="btns">    <button _id="customdialog_2">Cancel</button>    <button _id="customdialog_3">Save</button></div>` }
    });
}
  ...
  "bindings": [
    {
      ...
      "inject": (c) => c.comp.__01fcbdc77c536a7aee851dbb8215c638method0(),
      "extract": (c, v) => c.comp.__01fcbdc77c536a7aee851dbb8215c638method1(v),
      "once": true
    },
    {
      "id": "customdialog_1",
      ...
      "inject": (c) => c.comp.__01fcbdc77c536a7aee851dbb8215c638method2(),
      "extract": (c, v) => c.comp.__01fcbdc77c536a7aee851dbb8215c638method3(v),
      "once": true
    }
  ],
  "pressEvents": [
    ...
    __01fcbdc77c536a7aee851dbb8215c638method0() {
        return this.person.firstname;
    }
    __01fcbdc77c536a7aee851dbb8215c638method1(v) {
        if (this.person) {
            this.person.firstname = v;
        }
    }
    __01fcbdc77c536a7aee851dbb8215c638method2() {
        return this.person.lastname;
    }
    __01fcbdc77c536a7aee851dbb8215c638method3(v) {
        if (this.person) {
...
CustomDialog.Namespace=`dialog`;
CustomDialog.Tag=`av-custom-dialog`;
_.CustomDialog=CustomDialog;
if(!window.customElements.get('av-custom-dialog')){window.customElements.define('av-custom-dialog', CustomDialog);Aventus.WebComponentInstance.registerDefinition(CustomDialog);}

const Alert = class Alert extends Dialog {
    get 'options'() {
    ...
    this.__addWatchesActions("options");    super.__registerWatchesActions();
}
    static __style = `:host .title{font-size:18px;font-weight:bold;margin-bottom:12px}:host .buttons{display:flex;justify-content:flex-end}`;
    __getStatic() {
        return Alert;
    }
    __getStyle() {
    ...
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<div class="title" _id="alert_0"></div><div class="description" _id="alert_1"></div><div class="buttons">    <button _id="alert_2"></button></div>` }
    });
}
    __registerTemplateAction() { super.__registerTemplateAction();this.__getStatic().__template.setActions({
  "content": {
    "alert_0°@HTML": {
      "fct": (c) => `${c.print(c.comp.__a701efb1db1c5435e6dcf44536429c6dmethod0())}`,
      "once": true
    },
    "alert_1°@HTML": {
      "fct": (c) => `${c.print(c.comp.__a701efb1db1c5435e6dcf44536429c6dmethod1())}`,
      "once": true
    },
    "alert_2°@HTML": {
      "fct": (c) => `${c.print(c.comp.__a701efb1db1c5435e6dcf44536429c6dmethod2())}`,
      "once": true
    }
  },
  "pressEvents": [
    ...
    __a701efb1db1c5435e6dcf44536429c6dmethod0() {
        return this.options.title;
    }
    __a701efb1db1c5435e6dcf44536429c6dmethod1() {
...
const App = class App extends Aventus.WebComponent {
    get 'minimax'() {
						return this.__watch["minimax"];
					}
					set 'minimax'(val) {
						this.__watch["minimax"] = val;
					}    __registerWatchesActions() {
    this.__addWatchesActions("minimax");    super.__registerWatchesActions();
}
    static __style = ``;
    constructor() {
        super();
    ...
    __getHtml() {
    this.__getStatic().__template.setHTML({
        blocks: { 'default':`<button _id="app_0">Alert</button><button _id="app_1">New person</button><button _id="app_2"></button><button _id="app_3">External call</button>` }
    });
}
    __registerTemplateAction() { super.__registerTemplateAction();this.__getStatic().__template.setActions({
  "content": {
    "app_2°@HTML": {
      "fct": (c) => `Update ${c.print(c.comp.__ce515a47f82d2665bc2cdf10fa1fceacmethod0())} ${c.print(c.comp.__ce515a47f82d2665bc2cdf10fa1fceacmethod1())}`,
      "once": true
    }
  },
  "pressEvents": [
    {
      "id": "app_0",
      "onPress": (e, pressInstance, c) => { c.comp.showAlert(e, pressInstance); }
    },
    {
      "id": "app_1",
      "onPress": (e, pressInstance, c) => { c.comp.newPerson(e, pressInstance); }
    },
    {
      "id": "app_2",
      "onPress": (e, pressInstance, c) => { c.comp.updatePerson(e, pressInstance); }
    },
    {
      "id": "app_3",
      "onPress": (e, pressInstance, c) => { c.comp.externalCall(e, pressInstance); }
    }
  ]
}); }
    getClassName() {
    ...
    __defaultValuesWatch(w) { super.__defaultValuesWatch(w); w["minimax"] = undefined; }
    __upgradeAttributes() { super.__upgradeAttributes(); this.__correctGetter('minimax'); }
    async showAlert() {
        await Alert.show({
            title: "Test alert",
    ...
    __ce515a47f82d2665bc2cdf10fa1fceacmethod0() {
        return this.minimax.firstname;
    }
    __ce515a47f82d2665bc2cdf10fa1fceacmethod1() {
        return this.minimax.lastname;
    }
}
App.Namespace=`dialog`;
App.Tag=`av-app`;
_.App=App;
...
for(let key in _) { dialog[key] = _[key] }
})(dialog);
